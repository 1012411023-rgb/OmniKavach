...
export default function PatientNote({ note, highlightedWords = [] }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700/50 rounded-xl p-4 hover:border-slate-300 dark:hover:border-slate-600/60 transition-colors animate-fade-in shadow-sm dark:shadow-none">
      {/* Header */}
